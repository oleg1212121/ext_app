...
class Test extends Controller
{
    ...
    public function getCrossword(GetCrosswordRequest $request)
    {
        ...
        $level = $levels[$request->input('level', 0)] ?? 'less_100';
    ...
    public function crosswordReact(string $lang = 'en')
    {
        return Inertia::render('Crossword', [
            'lang' => $lang,
            'texts' => $this->entitiesForLanguage($lang),
        ]);
    }
