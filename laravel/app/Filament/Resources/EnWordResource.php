...
use App\Filament\Resources\EnWordResource\Pages;
use App\Filament\Resources\EnWordResource\RelationManagers;
...
class EnWordResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'English Word';
    ...
    {
        return [
            'index' => Pages\ListEnWords::route('/'),
            'create' => Pages\CreateEnWord::route('/create'),
            'edit' => Pages\EditEnWord::route('/{record}/edit'),
        ];
    }
}
