...
export default function Spinner(props) {
    return (
        <div className="absolute top-2 right-2 z-40 flex flex-col items-end gap-1.5 pointer-events-none">
            {props.pending === true && (
                <div
                    className="px-2.5 py-1 text-xs flex items-center gap-1.5 rounded-md shadow-md border font-serif italic
                    ...
                    <svg className="animate-spin h-3 w-3 text-[var(--color-vermilion)] dark:text-[var(--color-vermilion-night)]"
            ...
            {props.errors?.length > 0 && (
                <div
                    className="px-2.5 py-1 text-xs flex items-center gap-1.5 rounded-md shadow-md border font-medium
