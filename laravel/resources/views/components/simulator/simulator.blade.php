<div class="body w-full flex-1 flex flex-col overflow-hidden bg-orange-50 dark:bg-gray-900"
@mouseup.ctrl.alt="showSelectionModal()"
@dblclick="memorizeHighlight()"
@keydown.window="memorizeHighlight()"
>
    <!-- Selection Modal -->
    <div id="selection-modal" class="absolute bg-white dark:bg-gray-800 shadow-lg rounded-md z-50 p-2 border border-gray-400 dark:border-gray-600" x-show="pep">
        <span @click="saveSelection()" class="px-2 py-1 cursor-pointer text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900 rounded transition">+</span>
        <span class="cursor-pointer px-2 py-1 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition" @click="pep = !pep">×</span>
    </div>
    ...
    <div class="flex-none bg-white dark:bg-gray-800 border-b-2 border-gray-400 dark:border-gray-600 shadow-md">
        <div class="flex items-center gap-3 px-4 py-3">
            ...
            <div class="flex items-center gap-2">
                <select class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 text-sm rounded-md px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-gray-600 dark:focus:ring-gray-500 focus:border-transparent transition"
            ...
            <div class="flex items-center gap-1">
                <button class="w-8 h-8 flex items-center justify-center bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 hover:cursor-pointer text-gray-700 dark:text-gray-200 rounded transition"
            ...
            <!-- View Toggles -->
            <div class="flex items-center gap-1">
                <button class="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 hover:cursor-pointer text-gray-700 dark:text-gray-200 text-sm rounded transition"
    ...
    <div class="flex-none z-40">
        <div x-show="spinner" x-transition class="bg-gray-200 dark:bg-gray-700 border-b-2 border-gray-400 dark:border-gray-600 px-4 py-2.5 text-sm text-gray-800 dark:text-gray-200 flex items-center gap-2 font-medium">
            <svg class="animate-spin h-4 w-4 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
            <span>Processing...</span>
        </div>
        <div x-show="isError" x-transition class="bg-red-100 dark:bg-red-900 border-b-2 border-red-300 dark:border-red-700 px-4 py-2.5 text-sm text-red-800 dark:text-red-200 flex items-center gap-2 font-medium">
    ...
    >
        ...
        <div x-show="leftColumn" x-transition class="flex-1 flex flex-col bg-orange-50 dark:bg-gray-800 border-r-2 border-gray-400 dark:border-gray-600 overflow-hidden shadow-sm">
            <div class="flex-1 overflow-y-auto bg-white dark:bg-gray-700 pb-5">
                <table class="table w-full">
                    <thead class="sticky top-0 bg-gray-100 dark:bg-gray-800 border-b-2 border-gray-400 dark:border-gray-600 z-10 shadow-sm">
                        <tr class="text-sm font-semibold text-gray-800 dark:text-gray-200">
                            <th class="px-4 py-3 text-left">
                                <div class="flex items-center gap-2">
                                    <span>English</span>
                                    <input type="checkbox" class="all_en w-4 h-4 text-gray-700 dark:text-gray-300 rounded border-gray-300 dark:border-gray-600 focus:ring-gray-600 dark:bg-gray-700" id="all_en" />
                                </div>
                            </th>
                            ...
                            <th class="px-4 py-3 text-left">
                                <div class="flex items-center gap-2">
                                    <span>Russian</span>
                                    <input type="checkbox" class="all_ru w-4 h-4 text-gray-700 dark:text-gray-300 rounded border-gray-300 dark:border-gray-600 focus:ring-gray-600 dark:bg-gray-700" id="all_ru" />
                                </div>
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
                        <template x-for="(item, index) in rows" :key="index">
                            <tr class="row hover:bg-gray-50 dark:hover:bg-gray-600 transition group">
                                <td class="px-4 py-3 hide_en">
                                    <div class="flex flex-col gap-1">
                                        <span class="eng content resizeable_element text-gray-800 dark:text-gray-200" x-text="item[0]"></span>
                                    </div>
                                </td>
                                ...
                                <td class="px-2 py-3 text-center text-sm text-gray-500 dark:text-gray-400 resizeable_element" x-text="index"></td>
                                <td class="px-2 py-3 text-center">
                                    <input type="checkbox"
                                ...
                                <td class="px-4 py-3 hide_ru">
                                    <div class="flex flex-col gap-2">
                                        <span class="rus content resizeable_element text-gray-800 dark:text-gray-200" x-text="item[1]"></span>
                                        <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition">
                                            <button class="px-2 py-1 bg-gray-700 dark:bg-gray-600 hover:bg-gray-800 dark:hover:bg-gray-500 hover:cursor-pointer text-white text-xs rounded transition"
                                                @click.prevent="openWorkplace()">
                                                Open
                                            </button>
                                            <button class="px-2 py-1 bg-emerald-600 dark:bg-emerald-700 hover:bg-emerald-700 dark:hover:bg-emerald-600 hover:cursor-pointer text-white text-xs rounded transition"
            ...
            <div class="flex-none border-t-2 border-gray-400 dark:border-gray-600 bg-orange-50 dark:bg-gray-800 shadow-lg max-h-[40vh] overflow-y-auto pb-5">
        ...
        <div x-show="middleColumn" x-transition
            class="flex flex-col bg-orange-50 dark:bg-gray-800 border-r-2 border-gray-400 dark:border-gray-600 overflow-hidden shadow-sm"
            :style="`width: ${middleColumnWidth}px`">
            <!-- Width Controls -->
            <div class="flex-none flex items-center justify-end gap-1 p-2 border-b-2 border-gray-400 dark:border-gray-600 bg-orange-50 dark:bg-gray-800">
                <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 mr-auto ml-2">AI Response</span>
                <button class="w-7 h-7 flex items-center justify-center bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 hover:cursor-pointer text-gray-800 dark:text-gray-200 rounded transition text-sm font-bold"
            ...
            <div class="flex-1 overflow-y-auto p-4 bg-white dark:bg-gray-700 pb-5 mb-5">
                <div x-html="aiAnswer" id="ai_answer_div" class="resizeable_element prose prose-sm dark:prose-invert max-w-none"></div>
            </div>
        </div>

        <!-- Right Column: Dictionary -->
        <div x-show="rightColumn" x-transition
            class="flex flex-col bg-orange-50 dark:bg-gray-800 overflow-hidden shadow-sm"
            :style="`width: ${rightColumnWidth}px`">
            <!-- Controls -->
            <div class="flex-none flex items-center justify-between gap-2 p-2 border-b-2 border-gray-400 dark:border-gray-600 bg-orange-50 dark:bg-gray-800">
                <div class="flex gap-1">
                    <button class="w-8 h-8 flex items-center justify-center bg-emerald-600 dark:bg-emerald-700 hover:bg-emerald-700 dark:hover:bg-emerald-600 hover:cursor-pointer text-white rounded transition shadow-sm"
                        @click.prevent="createAnki()" title="Create Anki Card">
                        +
                    </button>
                    <button class="w-8 h-8 flex items-center justify-center bg-gray-700 dark:bg-gray-600 hover:bg-gray-800 dark:hover:bg-gray-500 hover:cursor-pointer text-white rounded transition shadow-sm"
