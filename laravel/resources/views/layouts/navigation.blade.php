<nav class="border-b bg-orange-100 dark:bg-gray-800 dark:border-gray-700"
            ...
            <div class="flex items-center gap-4">
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="flex items-center text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:cursor-pointer">
